...
class Order(models.Model):
    ...
    numberphone = models.CharField(max_length=50,null=False,blank=False)#blank=False: nghia la truong nay bat buoc
    email = models.CharField(max_length=50,null=True,blank=True)#co the trong
